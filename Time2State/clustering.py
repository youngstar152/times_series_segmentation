...
# class MeanShift(BasicClusteringClass):
#     def __init__(self):
#         self.n_component =10
#     def fit(self, X):
#         meanshift = SklearnMeanShift()
#         y_meanshift = meanshift.fit(X)
#         return y_meanshift
    
# class DBSCAN(BasicClusteringClass):
#     def __init__(self):
#         self.n_component =10
#     def fit(self, X):
#         meanshift = DBSCAN()
...
# class HDBSCAN(BasicClusteringClass):
#     def __init__(self):
#         self.n_component =10
#     def fit(self, X):
#         meanshift = hdbscan.HDBSCAN()
#         y_meanshift = meanshift.fit(X)
#         return y_meanshift
